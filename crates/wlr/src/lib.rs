...
//!
//! wlroots owns nearly everything you touch. Its 0.15 API has 80
//! `wlr_*_create` functions but only 37 `wlr_*_destroy`, and 79 types that
...
//! README. The design record that explains why, along with the rest of the
//! design, is `docs/superpowers/specs/2026-08-03-wlr-safe-wrapper-design.md` on
//! the repository's `develop` branch — it is written once for every branch
//! rather than copied onto each, and where it and this branch's code disagree,
//! the code is right.
