...
| `0.19` | 0.19 | Ubuntu 26.04 | published |
...
Only `0.20` and `0.19` exist today. The other older lines are named here
because [`wlr-sys`](https://crates.io/crates/wlr-sys) already binds them and
`wlr` follows on the same branches, not because they are on crates.io yet.
